...
#ifndef __DCACHEDEMOSERVANT_H_
#define __DCACHEDEMOSERVANT_H_
...
namespace DCacheDemo
{

    /* callback of async proxy for client */
    class DCacheDemoServantPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~DCacheDemoServantPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __DCacheDemoServant_all[]=
            {
                "test"
            };
            pair<string*, string*> r = equal_range(__DCacheDemoServant_all, __DCacheDemoServant_all+1, string(msg->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __DCacheDemoServant_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<DCacheDemoServantPrxCallback> DCacheDemoServantPrxCallbackPtr;

    //callback of promise async proxy for client
    class DCacheDemoServantPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~DCacheDemoServantPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< DCacheDemoServantPrxCallbackPromise::Promisetest > PromisetestPtr;

        DCacheDemoServantPrxCallbackPromise(const tars::Promise< DCacheDemoServantPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const DCacheDemoServantPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< DCacheDemoServantPrxCallbackPromise::PromisetestPtr > _promise_test;
        ...
        virtual int onDispatch(tars::ReqMessagePtr msg)
        {
            ...
            switch(r.first - __DCacheDemoServant_all)
            {
                case 0:
                {
                    ...
                    DCacheDemoServantPrxCallbackPromise::PromisetestPtr ptr = new DCacheDemoServantPrxCallbackPromise::Promisetest();
    ...
    typedef tars::TC_AutoPtr<DCacheDemoServantPrxCallbackPromise> DCacheDemoServantPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class DCacheDemoServantCoroPrxCallback: public DCacheDemoServantPrxCallback
    {
    public:
        virtual ~DCacheDemoServantCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<DCacheDemoServantCoroPrxCallback> DCacheDemoServantCoroPrxCallbackPtr;

    /* proxy for client */
    class DCacheDemoServantProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(DCacheDemoServantPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *pSptd = ServantProxyThreadData::getData();
        ...
        tars::Future< DCacheDemoServantPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< DCacheDemoServantPrxCallbackPromise::PromisetestPtr > promise;
            DCacheDemoServantPrxCallbackPromisePtr callback = new DCacheDemoServantPrxCallbackPromise(promise);
        ...
        void coro_test(DCacheDemoServantCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        DCacheDemoServantProxy* tars_hash(int64_t key)
        {
            return (DCacheDemoServantProxy*)ServantProxy::tars_hash(key);
        }

        DCacheDemoServantProxy* tars_consistent_hash(int64_t key)
        {
            return (DCacheDemoServantProxy*)ServantProxy::tars_consistent_hash(key);
        }

        DCacheDemoServantProxy* tars_open_trace(bool traceParam = false)
        {
            return (DCacheDemoServantProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        DCacheDemoServantProxy* tars_set_timeout(int msecond)
        {
            return (DCacheDemoServantProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "DCacheDemoServantProxy"; }
    };
    typedef tars::TC_AutoPtr<DCacheDemoServantProxy> DCacheDemoServantPrx;

    /* servant for server */
    class DCacheDemoServant : public tars::Servant
    {
    public:
        virtual ~DCacheDemoServant(){}
    ...
    public:
        ...
        {
            static ::std::string __DCacheDemo__DCacheDemoServant_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__DCacheDemo__DCacheDemoServant_all, __DCacheDemo__DCacheDemoServant_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __DCacheDemo__DCacheDemoServant_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
